...
export const selectIsEndgameModalOpen = state => state.statuses.isEndgameModalOpen;
export const selectIsShowingAnswers = state => state.statuses.isShowingAnswers;